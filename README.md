...
-	Effect of discount on customer behavior
...
-	Uncalculated field like profit, profit margin, and discount % were add using DAX

## Data Modelling
-	Established relationship between sales and product tables using product ID
